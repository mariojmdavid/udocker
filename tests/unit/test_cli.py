...
class UdockerCLITestCase(TestCase):
    ...
    def test_02__cdrepo(self):
        """Test02 UdockerCLI()._cdrepo()."""

    # @patch('udocker.cli.KeyStore')
    # @patch('udocker.cli.DockerIoAPI')
    # @patch('udocker.cli.Msg')
    # def test_03__check_imagespec(self, mock_msg, mock_dioapi, mock_ks):
    ...
    # def test_04__check_imagerepo(self):
    ...
    # @patch('udocker.cli.Msg')
    # def test_07_do_mkrepo(self, mock_msg, mock_exists, mock_cmdget):
